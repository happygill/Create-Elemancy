...
public class Advancement {
    ...
    static final String LANG = "advancement." + Elemancy.ID + ".";
    static final String SECRET_SUFFIX = "\n\u00A77(Hidden Advancement)";

    private net.minecraft.advancements.Advancement.Builder builder;
    private SimpleCreateTrigger builtinTrigger;
    private Advancement parent;

    net.minecraft.advancements.Advancement datagenResult;

    private String id;
    private String title;
    private String description;

    public Advancement(String id, UnaryOperator<Builder> b) {
        this.builder = net.minecraft.advancements.Advancement.Builder.advancement();
        this.id = id;
        ...
        if (!t.externalTrigger) {
            builtinTrigger = ElemancyTriggers.addSimple(id + "_builtin");
        ...
        ElemancyAdvancements.ENTRIES.add(this);
    }
    ...
    public boolean isAlreadyAwardedTo(Player player) {
        if (!(player instanceof ServerPlayer sp))
            return true;
        net.minecraft.advancements.Advancement advancement = sp.getServer()
                .getAdvancements()
                .getAdvancement(Elemancy.asResource(id));
        if (advancement == null)
            return true;
    ...
    void save(Consumer<net.minecraft.advancements.Advancement> t) {
        if (parent != null)
            builder.parent(parent.datagenResult);
        datagenResult = builder.save(t, Elemancy.asResource(id)
                .toString());
    }
    ...
    class Builder {
        ...
        Builder after(Advancement other) {
            Advancement.this.parent = other;
            return this;
        }
        ...
        Builder title(String title) {
            Advancement.this.title = title;
            return this;
        }

        Builder description(String description) {
            Advancement.this.description = description;
            return this;
        }
