...
public class ElemancySoundEvents {
    ...
    public static final SoundEntry
            ...
            GRINDING = create("grinding").subtitle("Grinding noises")
    ...
    private static SoundEntryBuilder create(String name) {
        return create(Elemancy.asResource(name));
    }
    ...
    public static class SoundEntryProvider implements DataProvider {
        ...
        public String getName() {
            return "Create Elemancy's Custom Sounds";
        }

        public CompletableFuture<?> generate(Path path, CachedOutput cache) {
            path = path.resolve("assets/createelemancy");
    ...
    public static class SoundEntryBuilder {
        ...
        public SoundEntryBuilder addVariant(String name) {
            return addVariant(Elemancy.asResource(name));
        }
